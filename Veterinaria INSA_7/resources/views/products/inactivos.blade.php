                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body" style="margin-left:4%; margin-right:4%;">
                                <BR>
                                <caption><h1 style="text-align:center"> PRODUCTOS ELIMINADOS</h1></caption>
                                <br>
                                            ...
                                            @foreach($productos as $producto)
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle" class="text-center">
                                                        <form action="{{action('ProductsController@activar', $producto->id)}}" method="POST">
                                                            {{ method_field('DELETE') }}
                                                            {{ csrf_field() }}
                                                            <button type="submit" class="btn btn-primary  bi-arrow-counterclockwise" onclick="return confirm('¿Seguro que desea activar esta Producto?')"></button>
                                                        </form>
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                @else
                                    <h2>No hay Productos Eliminados</h2>
                                @endif
                            </div>
                        </div>
