                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body" style="margin-left:4%; margin-right:4%;">
                                <BR>
                                <caption><h1 style="text-align:center"> LISTA DE PRODUCTOS</h1></caption>
                                <br>
                                <td><a href="{{url('/create')}}" class="btn btn-warning"> Agregar Producto</a></td>
                                <br><br>
                                @if ($productos->isNotEmpty())
                                    ...
                                    <table class="table table-borderless datatable table-hover" style="border: #1b1e21 " >
                                        ...
                                        <tr>
                                                ...
                                                <th scope="col" style="color:white; width:7%" class="text-center">Descripción </th>
                                            ...
                                            @foreach($productos as $producto)
                                                <tr>
                                                    ...
                                                    <td  style="vertical-align: middle" class="text-center">
                                                        <a href="{{route('producto.edit',$producto->id)}}"class="btn btn-success bx bxs-edit-alt "></a>
                                                        <form style="padding-top:19px" action="{{action('ProductsController@destroy', $producto->id)}}" method="POST">
                                                            {{ method_field('DELETE') }}
                                                            {{ csrf_field() }}
